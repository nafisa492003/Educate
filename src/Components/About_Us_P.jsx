...
const About_Us_P = () => {
  return (
    <section className="my-[80px] md:my-[120px]">
      <Container>
        <Flex className={`gap-[65px] flex-col lg:flex-row`}>
          ...
          <p className="font-semibold font-Urbanist text-[16px] text-hash my-5 lg:my-10 text-center lg:text-start">It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks  The generated Lorem Ipsum is therefore always free from repetition</p>
          <Flex className={`items-center justify-center lg:justify-start gap-4 md:gap-[30px]`}>
          <TbTargetArrow size={50} className="text-blue" />
          <h3 className="font-Urbanist font-bold text-[32px] text-regal-blue">Our Mission</h3>
          </Flex>
          <p className="font-semibold font-Urbanist text-[16px] text-hash my-5 lg:my-6 w-full lg:w-[642px] text-center lg:text-start">
